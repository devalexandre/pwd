...
$this->rodape = '20%';
    ...
    public function setRodape($margin){
...
@media screen and (max-width: 767px) {
  ...
  .ptable-responsive > .ptable-bordered > tfoot > tr:last-child > td {
    ...
    public function saveClear($filename)
    {
        $this->table->add($this->thead);
        $this->table->add($this->tbody);
...
';
        ...
        echo "</head>\n";
        // inclui a tabela no documento
           echo "<img src='http://ivan.progs.net.br/img/logo.jpg' width='100%' height='100' style='margin-top:0'/>";
        $this->table->show();
        echo "<img src='http://ivan.progs.net.br/img/rodape.jpg' width='100%'
         height='100' style='margin-top:$this->rodape'/>";
        echo "</html>";
        $content = ob_get_clean();
